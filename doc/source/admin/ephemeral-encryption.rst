...
By default, in order to create secrets in Barbican, a user must have the
``creator`` role in Keystone.
...
means that only users who have permission to access to the secret identified by
