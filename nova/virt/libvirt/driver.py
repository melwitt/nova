...
class LibvirtDriver(driver.ComputeDriver):
    ...
    def _create_snapshot_encryption_metadata(
        ...
        if encryption:
            ...
            if instance.task_state not in task_states.shelving_states:
                ...
                # Reuse the existing secret to avoid a potential change in ownership.
                # Example: an admin shelves the instance of a non-admin. We don't
                # want the non-admin user to lose access to the secret for their
                # shelved instance snapshot.
    ...
    def rescue(self, context, instance, network_info, image_meta,
        ...
        if hardware.get_ephemeral_encryption_constraint(
            ...
            rescue_disk_id = 'rescue_disk'
            secret_usage = f'{instance.uuid}_{rescue_disk_id}'
            ...
            rescue_bdi['image'][0]['uuid'] = rescue_disk_id
