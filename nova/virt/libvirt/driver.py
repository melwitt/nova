...
class LibvirtDriver(driver.ComputeDriver):
    ...
    def _needs_rebase_original_qcow2_image(self, instance, backend):
        if not isinstance(backend, self.image_backend.backend('qcow2')):
            return False
        ...
        if not is_shared_instance_path:
            ...
            if not is_shared_block_storage:
                ...
                self._create_images_and_backing(
                    ...
                    disk_info_mapping, fallback_from_host=instance.host)
    ...
    def _create_images_and_backing(self, context, instance, instance_dir,
        ...
        """:param context: security context
           ...
           :param disk_info:
               ...
               (list of dicts)
           :param disk_info_mapping: disk mapping (dict)
        ...
        for info in disk_info:
            ...
            if not info['backing_file'] and not os.path.exists(instance_disk):
                ...
                disk = self.image_backend.by_name(
                    ...
                    image_type=disk_info_mapping[base]['image_type'])
                if cache_name.startswith('ephemeral'):
                    ...
                    disk.create_root(
                        context, info['virt_disk_size'], instance.image_ref,
