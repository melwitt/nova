...
class LibvirtDriver(driver.ComputeDriver):
    ...
    def _create_secret_for_vtpm(
        ...
        secret_security = self._get_instance_tpm_secret_security(context,
                                                                 instance)
        confirmed = instance.system_metadata.get(
            'tpm_secret_security_confirmed')

        if secret_security == 'deployment' and confirmed == 'True':
    ...
    def _delete_secret_for_vtpm(
        ...
        if security == 'deployment' and confirmed:
            context = nova_context.get_service_user_context()
    ...
    def _post_live_migration_at_destination_vtpm(self, instance):
        ...
        confirmed = instance.system_metadata.get(
            'tpm_secret_security_confirmed')
        if secret_uuid and security == 'deployment' and confirmed == 'True':
            self._host.delete_secret('vtpm', instance.uuid)
