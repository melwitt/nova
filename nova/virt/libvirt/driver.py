...
class LibvirtDriver(driver.ComputeDriver):
    ...
    def _confirm_tpm_secret_security(self, context, instance):
        ...
        """
        if 'vtpm_secret_uuid' not in instance.system_metadata:
            return
        ...
        if 'image_hw_tpm_secret_security' not in instance.system_metadata:
            ...
            if secret_security is None:
                LOG.warning('Unable to confirm TPM secret security because '
                            'no provisional_tpm_secret_security was found.',
                            instance=instance)
                return
