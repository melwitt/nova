...
class Rbd(Image):
    ...
    def snapshot_extract(self, target, out_format, encryption=None,
        ...
        @utils.synchronized(target, external=True, lock_path=self.lock_path)
        def export_and_convert_rbd_image(in_path, out_path, in_format,
                                         out_format, encryption=None,
                                         dest_encryption=None):
            ...
            self.driver.export_image(in_path, image, '', pool=pool)
            images.convert_image(
                in_path,
                out_path,
                in_format,
