...
class ComputeManager(manager.Manager):
    ...
    def reset_ephemeral_encryption_bdms_sysmeta(
        ...
        """Reset ephemeral encryption attributes in BDMs and instance sys meta
        ...
        The image properties in the BDMs and system metadata need to be updated
        ...
        """
        # image_meta can be an empty objects.ImageMeta() (example: rebuild
