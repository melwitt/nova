...
class TestSecurityGroups(test.TestCase):
    ...
    def test_create_security_group(self):
        ...
        req = fakes.HTTPRequest.blank('/v3/os-security-groups')
    ...
    def test_get_security_group_by_instance(self):
        ...
        req = fakes.HTTPRequest.blank('/v3/%s/servers/%s/os-security-groups' %
                                      ('fake', FAKE_UUID1))
    ...
    def test_get_security_group_by_id(self):
        ...
        req = fakes.HTTPRequest.blank('/v3/os-security-groups/2')
    ...
    def test_get_security_group_by_invalid_id(self):
        req = fakes.HTTPRequest.blank('/v3/os-security-groups/invalid')
        self.assertRaises(webob.exc.HTTPBadRequest, self.controller.delete,
                          req, 'invalid')

    def test_get_security_group_by_non_existing_id(self):
        req = fakes.HTTPRequest.blank('/v3/os-security-groups/%s' %
                                      self.fake_id)
    ...
    def test_update_default_security_group_fail(self):
        ...
        req = fakes.HTTPRequest.blank('/v3/os-security-groups/1')
        self.assertRaises(webob.exc.HTTPBadRequest, self.controller.update,
    ...
    def test_associate_by_non_existing_security_group_name(self):
        ...
        req = fakes.HTTPRequest.blank('/v3/servers/1/action')
        self.assertRaises(webob.exc.HTTPNotFound,
    ...
    def test_associate_by_invalid_server_id(self):
        ...
        req = fakes.HTTPRequest.blank('/v3/servers/invalid/action')
        self.assertRaises(webob.exc.HTTPNotFound,
...
class TestSecurityGroupRules(test.TestCase):
    ...
    def test_create_by_cidr(self):
        ...
        req = fakes.HTTPRequest.blank('/v3/os-security-group-rules')
    ...
    def test_delete(self):
        ...
        req = fakes.HTTPRequest.blank('/v3/os-security-group-rules/%s'
                                      % self.sg2['id'])
...
class SecurityGroupsOutputTest(test.TestCase):
    ...
    def _make_request(self, url, body=None):
        ...
        res = req.get_response(fakes.wsgi_app_v3(
            init_only=('os-security-groups', 'servers')))
        return res
