...
class EncryptionSecretTest(test.NoDBTestCase):
    ...
    def _test_create_encryption_secret(
            self, mock_get_manager, mock_pass, mock_text, for_snapshot=False):
        ...
        secret_uuid, secret = crypto.create_encryption_secret(
            self.ctxt, instance, driver_bdm, for_snapshot=for_snapshot)
    ...
    def test_create_encryption_secret_for_snapshot(self):
        self._test_create_encryption_secret(for_snapshot=True)
