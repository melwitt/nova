    ...
    def _test_generate_resized_backing_files(self, mock_utime, mock_copy,
        ...
        if disk_info_mapping:
            encryption = {
                ...
                'secret': mock.sentinel.secret,
                'options': disk_info_mapping.get('encryption_options'),
            }
        mock_extend.assert_called_once_with(
...
class RbdTestCase(_ImageTestCase, test.NoDBTestCase):
    ...
    def test_image_create_with_encryption(self, mock_resize, mock_get_size,
            ...
            mock_get_secret, mock_exists, size=None, src_encryption=None):
        ...
        mock_convert.assert_called_once_with(
            self.TEMPLATE_PATH, self.TEMPLATE_PATH + '.converted', src_format,
            'luks', src_encryption=src_encryption,
            dest_encryption=expected_encryption)
